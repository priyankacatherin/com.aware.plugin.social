...
//  String [] tableColumns = new String[2];
  //      tableColumns[0] =SocialEsmProvider.Esm_Data.TIMESTAMP;
   //     tableColumns[1]=SocialEsmProvider.Esm_Data.SOCIALSITUATION;
     //   esm_data=getContentResolver().query(SocialEsmProvider.Esm_Data.CONTENT_URI,tableColumns,null,null,null);

        Intent get_Intent = getIntent();
        radioval = get_Intent.getStringExtra("Radio Value");
        Log.d("RADIO VALUE", radioval);

       final_text=get_Intent.getStringExtra("check Con");
        Log.e("CHECK CON",final_text);
        utime=EsmActivity.unix_time;
        System.out.println("UNIXTIME"+utime);
