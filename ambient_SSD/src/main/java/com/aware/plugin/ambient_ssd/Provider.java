...
public class Provider extends ContentProvider {
	...
	/**
	 * Provider authority: com.aware.plugin.ambient_ssd.provider.ambient_ssd
	 */
	public static String AUTHORITY = "com.aware.plugin.ambient_ssd.provider.ambient_ssd";
	
	private static final int AMBIENT_SSD = 1;
	private static final int AMBIENT_SSD_ID = 2;
	
	//public static final String DATABASE_NAME = Environment.getExternalStorageDirectory() + "/AWARE/plugin_ambientssd.db";
	public static String DATABASE_NAME="plugin_ambientssd.db";
	...
	public static final class AmbientNoise_Data implements BaseColumns {
		...
		public static final Uri CONTENT_URI = Uri.parse("content://"+AUTHORITY+"/plugin_ambient_ssd");
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.aware.plugin.ambient_ssd";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.aware.plugin.ambient_ssd";
	...
	public boolean onCreate() {
		...
		AUTHORITY = getContext().getPackageName() + ".provider.ambient_ssd";
		
		URIMatcher = new UriMatcher(UriMatcher.NO_MATCH);
		URIMatcher.addURI(AUTHORITY, DATABASE_TABLES[0], AMBIENT_SSD);
		URIMatcher.addURI(AUTHORITY, DATABASE_TABLES[0]+"/#", AMBIENT_SSD_ID);
